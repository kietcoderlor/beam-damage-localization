...
from src.models.baseline_mlp import (  # noqa: E402
    MlpBaselineConfig,
    MlpDamageBaseline,
)
...
def main() -> None:
    ...
    parser.add_argument("--output-name", type=str, default="baseline_mlp")

    parser.add_argument("--max-iter-clf", type=int, default=800)
    parser.add_argument("--max-iter-reg", type=int, default=1200)
    parser.add_argument("--alpha", type=float, default=1e-4)
    parser.add_argument("--hidden-1", type=int, default=128)
    parser.add_argument("--hidden-2", type=int, default=64)
    ...
    cfg = MlpBaselineConfig(
        ...
        max_iter_clf=args.max_iter_clf,
        max_iter_reg=args.max_iter_reg,
        alpha=args.alpha,
    )
